...
<div>
    ...
    <div class="group relative" data-password-toggle>
        ...
        <input id="{{ $name }}" name="{{ $name }}" type="{{ $type }}"
            ...
            class="w-full rounded-2xl border border-slate-200 bg-white py-2.5 pl-11 {{ $type === 'password' ? 'pr-14' : 'pr-5' }} text-slate-700 placeholder:text-slate-400 shadow-sm transition-all duration-300 hover:border-slate-300 outline-none focus:outline-none focus:border-[#1FA6A6] focus:ring-4 focus:ring-[#1FA6A6]/20">
